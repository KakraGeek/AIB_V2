      ...
      <div className="container-custom py-20">
        ...
        <ScrollAnimation animation="fadeIn" delay={0.2}>
          <div className="mb-16">
            ...
            <InteractiveCard hoverEffect="lift" className="p-8 bg-gradient-to-br from-primary-175 to-primary-150 border border-primary-200">
              <motion.p 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                  ...
                  <motion.div 
                    key={partner.name}
                    className="text-center p-6 bg-gradient-to-br from-secondary-175 to-primary-150 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 border border-secondary-200"
        ...
        <ScrollAnimation animation="fadeIn" delay={0.3}>
          <div>
            ...
            <InteractiveCard hoverEffect="glow" className="p-8 bg-gradient-to-br from-secondary-175 to-primary-150 border border-secondary-200">
              <motion.p 
                className="text-lg text-gray-700 mb-8 text-center"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  ...
                  <motion.div 
                    ...
                    className="bg-gradient-to-br from-primary-175 to-primary-200 p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 border border-primary-200"
                  >
                    <motion.h3 
